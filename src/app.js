...
server.post('/api/checkout', async (req, res) => {
	try {
		...
		let user = await axios.get(`https://pf-henry-gamesportal.herokuapp.com/users/${dataUser.id}`);
		console.log('userData', user.data);
		axios.put(`https://pf-henry-gamesportal.herokuapp.com/users/${dataUser.id}`, {
			plan: true,
		});
